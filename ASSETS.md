...
T04 and T05 use the seven Poly Haven CC0 sources below. T05 adds no external sources. Poly Haven explicitly permits sharing and raw redistribution under [CC0](https://polyhaven.com/license). Attribution is not required by CC0; the artists are credited here. Asset discovery was powered by Poly Haven's public API; the game has no live API dependency.
