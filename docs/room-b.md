...
Automated Player-capsule sweeps cover the Room B aisle, bed collision, window boundary, Door traversal and closing, and both NPC exchanges. Subjective close-range art quality beyond the fixed captures still benefits from the manual walk-through above.
